    ...
    <body>
        ...
        <div class="about-box-main">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="banner-frame"> <img class="img-fluid" src="images/category-01.jpg" alt="" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h2 class="noo-sh-title-top">Chúng tôi là <span>NestSongAn</span></h2>
                        <p>"Trước đây, yến sào chủ yếu được khai thác và xuất bán thô với các loại: yến huyết, yến hồng, yến quang, yến thiên, yến bài
                            yến địa và yến vụn. Với ước mơ phổ biến hóa giá trị dinh dưỡng của yến sào đến với cộng đồng, năm 2002, Công ty đã thành lập Xưởng Chế biến nguyên liệu
                            yến sào sản xuất các sản phẩm yến tinh chế đầu tiên với dạng hộp trọng lượng 3g, 5g, yến nguyên tổ thành phẩm 20g tiện dụng cho người tiêu dùng.
                             Xưởng chế biến yến sào đã đưa ra dòng sản phẩm mới: yến đảo tinh chế hộp 50g, 100g; yến thành phẩm nguyên tổ 50g, 100g.
                            Đến nay, Công ty đưa ra thị trường dòng sản phẩm yến tinh chế dành cho người ăn kiêng đáp ứng nhu cầu thị trường..</p>
                    </div>
                </div>
              </div>
        </div>  
